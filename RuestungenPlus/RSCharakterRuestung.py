...
class Ui_formAusruestung(object):
    def setupUi(self, formAusruestung):
        ...
        self.gbRstungen = QGroupBox(formAusruestung)
        ...
        self.spinGesamtBauch.setAlignment(Qt.AlignCenter)
        self.spinGesamtBauch.setReadOnly(True)
        self.spinGesamtBauch.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtKopf.setAlignment(Qt.AlignCenter)
        self.spinGesamtKopf.setReadOnly(True)
        self.spinGesamtKopf.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtLarm.setAlignment(Qt.AlignCenter)
        self.spinGesamtLarm.setReadOnly(True)
        self.spinGesamtLarm.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtPunkte.setAlignment(Qt.AlignCenter)
        self.spinGesamtPunkte.setReadOnly(True)
        self.spinGesamtPunkte.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtBein.setAlignment(Qt.AlignCenter)
        self.spinGesamtBein.setReadOnly(True)
        self.spinGesamtBein.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtRS.setAlignment(Qt.AlignCenter)
        self.spinGesamtRS.setReadOnly(True)
        self.spinGesamtRS.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtBrust.setAlignment(Qt.AlignCenter)
        self.spinGesamtBrust.setReadOnly(True)
        self.spinGesamtBrust.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spinGesamtBE.setAlignment(Qt.AlignCenter)
        self.spinGesamtBE.setReadOnly(False)
        self.spinGesamtBE.setButtonSymbols(QAbstractSpinBox.PlusMinus)
        ...
        self.spinGesamtRarm.setAlignment(Qt.AlignCenter)
        self.spinGesamtRarm.setReadOnly(True)
        self.spinGesamtRarm.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.labelHinweis.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
