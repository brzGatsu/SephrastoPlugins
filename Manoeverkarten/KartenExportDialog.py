...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.labelNameFormat, 9, 0, 1, 1)

        self.labelOpen = QLabel(Dialog)
        self.labelOpen.setObjectName(u"labelOpen")

        self.gridLayout.addWidget(self.labelOpen, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelBilder, 7, 0, 1, 1)

        self.leNameFormat = QLineEdit(Dialog)
        self.leNameFormat.setObjectName(u"leNameFormat")

        self.gridLayout.addWidget(self.leNameFormat, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkOpen, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelEinzeln, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkHintergrund, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkEinzeln, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.treeCategories, 1, 0, 1, 2)
