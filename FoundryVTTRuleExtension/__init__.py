...
print("FoundryVTTRuleExtension Plugin module loaded") # Direct console output
...
class Plugin:
    def __init__(self):
        print("FoundryVTTRuleExtension Plugin initializing...") # Direct console output
    ...
    def datenbankLadenHook(self, params):
        print("FoundryVTTRuleExtension datenbankLadenHook called") # Direct console output
        ...
        try:
            ...
            print("FoundryVTTRuleExtension Plugin: Settings loaded successfully") # Direct console output
            
        except Exception as e:
            logger.error("Error in datenbankLadenHook: %s", str(e), exc_info=True)
            print(f"Error in FoundryVTTRuleExtension: {str(e)}") # Direct console output
            raise
