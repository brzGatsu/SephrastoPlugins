...
class Ui_formMain(object):
    def setupUi(self, formMain):
        ...
        self.gridLayout_2.addWidget(self.teAussehen, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sbIN, 0, 9, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sbCH, 0, 13, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sbFF, 0, 15, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.sbKL, 0, 11, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_9, 0, 14, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.groupBox_4, 1, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.leTalent7, 3, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent6, 2, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent3, 3, 1, 1, 1)

        self.leTalent6 = QLineEdit(self.groupBox_6)
        self.leTalent6.setObjectName(u"leTalent6")

        self.gridLayout_4.addWidget(self.leTalent6, 2, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent4, 4, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent5, 1, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent1, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.sbTalent7, 3, 3, 1, 1)

        self.leTalent2 = QLineEdit(self.groupBox_6)
        self.leTalent2.setObjectName(u"leTalent2")

        self.gridLayout_4.addWidget(self.leTalent2, 2, 0, 1, 1)


        self.verticalLayout_3.addLayout(self.gridLayout_4)


        self.gridLayout_11.addWidget(self.groupBox_6, 6, 0, 1, 2)
        ...
        self.sbAT = QSpinBox(self.groupBox_9)
        ...
        self.gridLayout_12.addWidget(self.sbAT, 0, 3, 1, 1)

        self.sbRS = QSpinBox(self.groupBox_9)
        ...
        self.gridLayout_12.addWidget(self.sbRS, 0, 7, 1, 1)
        ...
        self.sbGS = QSpinBox(self.groupBox_8)
        ...
        self.gridLayout.addWidget(self.sbGS, 0, 1, 1, 1)
        ...
        self.sbINI = QSpinBox(self.groupBox_8)
        ...
        self.gridLayout.addWidget(self.sbINI, 0, 3, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.label_29, 2, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 258, 672))
        ...
        QWidget.setTabOrder(self.spinRegelnGroesse, self.checkRegeln)
        QWidget.setTabOrder(self.checkRegeln, self.cbTier)
        QWidget.setTabOrder(self.cbTier, self.checkEditierbar)
        QWidget.setTabOrder(self.checkEditierbar, self.buttonLoadImage)
        QWidget.setTabOrder(self.buttonLoadImage, self.buttonLoad)
        QWidget.setTabOrder(self.buttonLoad, self.buttonQuicksave)
        QWidget.setTabOrder(self.buttonQuicksave, self.sbRK)
        QWidget.setTabOrder(self.sbRK, self.buttonSave)
        QWidget.setTabOrder(self.buttonSave, self.btnSavePdf)
        QWidget.setTabOrder(self.btnSavePdf, self.leName)
        QWidget.setTabOrder(self.leName, self.buttonDeleteImage)
        QWidget.setTabOrder(self.buttonDeleteImage, self.sbReiten)
        QWidget.setTabOrder(self.sbReiten, self.scrollArea)
        ...
        QWidget.setTabOrder(self.tabWidget, self.leNahrung)
        QWidget.setTabOrder(self.leNahrung, self.teAussehen)
        QWidget.setTabOrder(self.teAussehen, self.teHintergrund)
    ...
    def retranslateUi(self, formMain):
        ...
        self.label_3.setText(QCoreApplication.translate("formMain", u"Attribute", None))
        ...
        self.label_28.setText(QCoreApplication.translate("formMain", u"Abgeleitete Werte", None))
        self.label_28.setProperty(u"class", QCoreApplication.translate("formMain", u"h2", None))
        ...
        self.label_29.setText(QCoreApplication.translate("formMain", u"Kampfwerte", None))
        self.label_29.setProperty(u"class", QCoreApplication.translate("formMain", u"h2", None))
